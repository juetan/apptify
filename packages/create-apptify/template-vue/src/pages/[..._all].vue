<template>
  <div class="w-full h-full flex justify-center items-center p-4">
    <div class="flex gap-2 items-center">
      <div>
        <svg class="w-[480px]" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M295 89.7H100v115.799h195v-115.8Z" stroke="#0C296E" stroke-width=".5" stroke-miterlimit="10" />
          <path
          ...
          <path d="M132 172.699s32.4-27.7 55.8 20.2" stroke="#0C296E" stroke-width=".5" stroke-miterlimit="10" />
          <path d="M185.8 195s20.9-23.2 50-.2l-50 .2Z" fill="#fff" />
          <path d="M185.8 195s20.9-23.2 50-.2" stroke="#0C296E" stroke-width=".5" stroke-miterlimit="10" />
          <path d="M235.7 188.399s-2.8-25.3 30-19.5l-30 19.5Z" fill="#fff" />
          <path d="M235.7 188.399s-2.8-25.3 30-19.5" stroke="#0C296E" stroke-width=".5" stroke-miterlimit="10" />
          <path
